...
export const VEHICLE_OPTIONS = [
  ...
  { id: 'hilux_double', category: 'rugged_4x4', type: 'Pickup', name: 'Double Cab Bakkie', model: 'Toyota Hilux', drivetrain: '4x4', transmission: 'automatic', isHybrid: false, fuel: 'Diesel', fuelL100km: 10.5, maxPassengers: 5, maxLargeBags: 5, maxSmallBags: 5, desc: 'Load bed for gear, rooftop tent ready, Namibia\'s workhorse.', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?auto=format&fit=crop&w=800&q=80' },
  { id: 'jimny', category: 'rugged_4x4', type: '4x4', name: 'Compact 4x4', model: 'Suzuki Jimny', drivetrain: '4x4', transmission: 'automatic', isHybrid: false, fuel: 'Petrol', fuelL100km: 7.5, maxPassengers: 4, maxLargeBags: 1, maxSmallBags: 2, desc: 'Small but mighty. Perfect for couples on a budget.', image: 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&w=800&q=80' },

  // Group Travel
  { id: 'minivan', category: 'group_travel', type: 'Shuttle', name: 'Luxury Minivan', model: 'VW Caravelle', drivetrain: 'FWD', transmission: 'automatic', isHybrid: false, fuel: 'Diesel', fuelL100km: 8.5, maxPassengers: 8, maxLargeBags: 5, maxSmallBags: 6, desc: 'Premium group comfort for long distance tar travel.', image: 'https://images.unsplash.com/photo-1554672408-730436b60dde?auto=format&fit=crop&w=800&q=80' },
  { id: 'sprinter', category: 'group_travel', type: 'Bus', name: 'Touring Bus', model: 'Mercedes Sprinter', drivetrain: 'RWD', transmission: 'manual', isHybrid: false, fuel: 'Diesel', fuelL100km: 12, maxPassengers: 14, maxLargeBags: 10, maxSmallBags: 14, desc: 'Large group expeditions with professional drivers.', image: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?auto=format&fit=crop&w=800&q=80' },

  // Public & Specialty
  { id: 'adv_motorcycle', category: 'specialty', type: 'Motorcycle', name: 'Adventure Motorcycle', model: 'BMW R1250GS', drivetrain: '2WD', transmission: 'manual', isHybrid: false, fuel: 'Petrol', fuelL100km: 5, maxPassengers: 1, maxLargeBags: 0, maxSmallBags: 2, desc: 'Solo freedom on gravel paths.', image: 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&w=800&q=80' },
  { id: 'byo_4x4', category: 'specialty', type: '4x4', name: 'Bring Your Own (BYO)', model: 'Custom 4x4', drivetrain: '4x4', transmission: 'automatic', isHybrid: false, fuel: 'Any', fuelL100km: 12, maxPassengers: 5, maxLargeBags: 8, maxSmallBags: 8, desc: 'Planning a trip with your own specialized vehicle.', image: 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&w=800&q=80' },
];
